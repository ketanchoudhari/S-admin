...
@Component({
  selector: 'app-awc-casino-bets',
  templateUrl: './awc-casino-bets.component.html',
  styleUrls: ['./awc-casino-bets.component.scss']
})
export class AwcCasinoBetsComponent implements OnInit {
  ...
  listCasinoAWCBets() {
    ...
    this.awcCasino.listCasinoAWCBets(this.currentUser.userId,`${this.fromDate} ${this.fromTime}`,`${this.toDate} ${this.toTime}`,this.consolidateId,this.userName,+this.stake,'').subscribe((res: any) => {
      console.log(res);
