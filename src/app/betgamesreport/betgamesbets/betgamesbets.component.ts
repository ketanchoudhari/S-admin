...
@Component({
  selector: 'app-betgamesbets',
  templateUrl: './betgamesbets.component.html',
  styleUrls: ['./betgamesbets.component.scss']
})
export class BetgamesbetsComponent implements OnInit {
