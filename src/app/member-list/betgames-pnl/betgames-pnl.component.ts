...
@Component({
  selector: 'app-betgames-pnl',
  templateUrl: './betgames-pnl.component.html',
  styleUrls: ['./betgames-pnl.component.scss']
})
export class BetgamesPnlComponent implements OnInit {
