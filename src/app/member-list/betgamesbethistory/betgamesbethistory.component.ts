...
@Component({
  selector: 'app-betgamesbethistory',
  templateUrl: './betgamesbethistory.component.html',
  styleUrls: ['./betgamesbethistory.component.scss']
})
export class BetgamesbethistoryComponent implements OnInit {
  ...
  CasinobetHistory(){
    this.casino.CasinoBGBetsHistory( `${this.fromDate} ${this.fromTime}`,
