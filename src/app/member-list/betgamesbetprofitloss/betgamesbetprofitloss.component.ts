...
@Component({
  selector: 'app-betgamesbetprofitloss',
  templateUrl: './betgamesbetprofitloss.component.html',
  styleUrls: ['./betgamesbetprofitloss.component.scss']
})
export class BetgamesbetprofitlossComponent implements OnInit {
  fromDate;
  fromTime;
  toDate;
  toTime;
  ...
  CasinoprofitLoss(){
    this.casino.CasinoBGProfitLoss( `${this.fromDate} ${this.fromTime}`,
