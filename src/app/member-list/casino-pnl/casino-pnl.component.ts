...
@Component({
  selector: 'app-casino-pnl',
  templateUrl: './casino-pnl.component.html',
  styleUrls: ['./casino-pnl.component.scss']
})
export class CasinoPnlComponent implements OnInit {
  ...
  EtgCasino() {
    ...
    `${this.toDate} ${this.toTime}`,this.p, this.n,this.userId,this.selectedoperatorId).subscribe((res: any) => {
