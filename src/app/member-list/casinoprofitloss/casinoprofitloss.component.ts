...
@Component({
  selector: 'app-casinoprofitloss',
  templateUrl: './casinoprofitloss.component.html',
  styleUrls: ['./casinoprofitloss.component.scss']
})
export class CasinoprofitlossComponent implements OnInit {
  ...
  CasinoprofitLoss(){
    this.casino.casinoprofitLoss( `${this.fromDate} ${this.fromTime}`,
