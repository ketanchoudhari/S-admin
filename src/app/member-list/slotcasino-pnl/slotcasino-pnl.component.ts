...
@Component({
  selector: 'app-slotcasino-pnl',
  templateUrl: './slotcasino-pnl.component.html',
  styleUrls: ['./slotcasino-pnl.component.scss']
})
export class SlotcasinoPnlComponent implements OnInit {
