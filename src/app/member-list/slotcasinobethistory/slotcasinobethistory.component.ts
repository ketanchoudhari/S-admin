...
@Component({
  selector: 'app-slotcasinobethistory',
  templateUrl: './slotcasinobethistory.component.html',
  styleUrls: ['./slotcasinobethistory.component.scss']
})
export class SlotcasinobethistoryComponent implements OnInit {
  fromDate;
  fromTime;
  toDate;
  toTime;
  ...
  CasinobetHistory(){
    this.casino.CasinoSlotBetsHistory( `${this.fromDate} ${this.fromTime}`,
