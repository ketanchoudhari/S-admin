...
@Component({
  selector: 'app-slotcasinobetprofitloss',
  templateUrl: './slotcasinobetprofitloss.component.html',
  styleUrls: ['./slotcasinobetprofitloss.component.scss']
})
export class SlotcasinobetprofitlossComponent implements OnInit {
  fromDate;
  fromTime;
  toDate;
  toTime;
  ...
  CasinoprofitLoss(){
    this.casino.CasinoSlotProfitLoss( `${this.fromDate} ${this.fromTime}`,
