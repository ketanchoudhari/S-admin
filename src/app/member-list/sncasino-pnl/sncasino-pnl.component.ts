...
@Component({
  selector: 'app-sncasino-pnl',
  templateUrl: './sncasino-pnl.component.html',
  styleUrls: ['./sncasino-pnl.component.scss']
})
export class SncasinoPnlComponent implements OnInit {
