...
@Component({
  selector: 'app-sncasinobethistory',
  templateUrl: './sncasinobethistory.component.html',
  styleUrls: ['./sncasinobethistory.component.scss']
})
export class SncasinobethistoryComponent implements OnInit {
  ...
  Update: any;
    ...
    CasinobetHistory(){
      this.sncasino.casinoSNBetsHistory( `${this.fromDate} ${this.fromTime}`,
