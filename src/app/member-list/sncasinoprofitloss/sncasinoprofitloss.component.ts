...
@Component({
  selector: 'app-sncasinoprofitloss',
  templateUrl: './sncasinoprofitloss.component.html',
  styleUrls: ['./sncasinoprofitloss.component.scss']
})
export class SncasinoprofitlossComponent implements OnInit {
  ...
  Update: any;
    ...
    CasinoprofitLoss(){
      this.sncasino.casinoSNProfitLoss( `${this.fromDate} ${this.fromTime}`,
