...
@Component({
  selector: 'app-pl-diamondcasino',
  templateUrl: './pl-diamondcasino.component.html',
  styleUrls: ['./pl-diamondcasino.component.scss']
})
export class PlDiamondcasinoComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.commonService.apis$.subscribe((res) => {
      // this.getDownlinePL();
      // this.casinoTPPlReportByDownLine();
    });
  ...
  // }
  getdownlinedata() {
    this.reportsService.casinoTPPlReportByDownLine(
  ...
  casinoTPPlReportByDownLine() {
    ...
    let casinoTPPlReportByDownLine = this.reportsService.casinoTPPlReportByDownLine(
      `${this.fromDate} ${this.fromTime}`,
      `${this.toDate} ${this.toTime}`)
      ...
      .subscribe((res: GenericResponse<any[]>) => {
        ...
        if (res.errorCode === 0) {
          ...
          this.downlineList = PlDiamondcasinoComponent.addShowDownline(
            res.result[0]

          );
          this.downlineListHolder = PlDiamondcasinoComponent.addShowDownline(
            res.result[0]
          );
