...
@Component({
  selector: 'app-sncasinobets',
  templateUrl: './sncasinobets.component.html',
  styleUrls: ['./sncasinobets.component.scss']
})
export class SncasinobetsComponent implements OnInit {
  ...
  SNCasino() {
    ...
    this.sncasino.listCasinoSNBets(
